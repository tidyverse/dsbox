...
# create age_group for questions 5 & 6
...
This week we'll do some data gymnastics to refresh and review what we 
learned over the past few weeks.

### Learning goals

- Practice the analysis skills you have learned during the last weeks
- Use independent research to answer a question
- Deepen your understanding of visualisations
...
grade_code("The tidyverse and dsbox packages you'll use in this analysis are now loaded!")
```
