...
```{r rentals-vs-temp-check}
	 grade_result(
   pass_if(~ identical(floor(.result$estimate[2]), 161), "You have fit the model correctly"),
...
```{r rentals-vs-atemp-check}
	 grade_result(
   pass_if(~ identical(floor(.result$estimate[2]), 150), "You have fit the model correctly"),
   fail_if(~ identical(floor(.result$estimate[1]), 11), "Did you maybe try to predict the weather from the number of bike rentals?"),
   fail_if(~ identical(floor(.result$estimate[1]), 0), "Did you maybe try to predict the weather from the number of bike rentals?"),
...
```{r m-full-check}
	 grade_result(
   pass_if(~ identical(floor(.result$estimate[1]), 2715), "You have fit the model correctly"),
...
grade_result(
   pass_if(~ identical(as.numeric(round(.result, digits = 4)), 0.7491), "You have fit the model correctly"),
...
```{r remove-year-check}
grade_result(
   pass_if(~ identical(as.numeric(round(.result, digits = 5)), 0.5536), "You have fit the model correctly"),
...
grade_result(
   pass_if(~ identical(as.numeric(round(.result, digits = 4)), 0.8173), "You have fit the model correctly"),
...
grade_result(
   pass_if(~ identical(as.numeric(round(.result, digits = 4)), 0.8196), "You have fit the model correctly"),
   fail_if(~ TRUE, "Not quite. Did you use the full model as your starting point?")
 )
```
...
grade_result(
   pass_if(~ identical(as.numeric(round(.result, digits = 5)), 0.79847), "You have fit the model correctly"),
   fail_if(~ TRUE, "Not quite. Did you use the full model as your starting point?")
 )
```
...
grade_result(
   pass_if(~ identical(as.numeric(round(.result, digits = 5)), 0.81813), "You have fit the model correctly"),
   fail_if(~ TRUE, "Not quite. Did you use the full model as your starting point?")
 )
```
...
grade_result(
   pass_if(~ identical(as.numeric(round(.result, digits = 5)), 0.81988), "You have fit the model correctly"),
   fail_if(~ identical(as.numeric(round(.result, digits = 3)), 0.820), "Did you forget to remove the interaction effect?"),
   fail_if(~ TRUE, "Not quite. Did you use the full model as your starting point?")
 )
```
...
grade_result(
   pass_if(~ identical(as.numeric(round(.result, digits = 4)), 0.8151), "You have fit the model correctly"),
   fail_if(~ TRUE, "Not quite. Did you use the full model as your starting point?")
 )
```
...
grade_result(
   pass_if(~ identical(as.numeric(round(.result, digits = 4)), 0.8106), "You have fit the model correctly"),
   fail_if(~ TRUE, "Not quite. Did you use the full model as your starting point?")
 )
```
...
grade_result(
   pass_if(~ identical(as.numeric(round(.result, digits = 4)), 0.8197), "You have fit the model correctly"),
