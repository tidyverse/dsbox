...
```{r photo, fig.margin = TRUE, echo = FALSE, out.width="100%", fig.cap="Photo by Kira auf der Heide on Unsplash"}
knitr::include_graphics("images/08-tutorial.jpg")
```

It’s almost time to wrap up the course, with our final tutorial.
...
We hope you enjoyed this assignment.
