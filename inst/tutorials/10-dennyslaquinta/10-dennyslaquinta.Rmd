...
grade_this({
  if(identical(.result, 1) | identical(.result, 11L)) {
    pass(random_praise())
  }
...
question_text("Using the same 1.5 IQR method as for the North Carolina data, the Texas data has ___ outliers.",
  answer("23", message = "Are you comparing to the mean or the median? Which of those values refers to 50% of the data?"),
