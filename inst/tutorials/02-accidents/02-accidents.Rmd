...
description: >
  Learn data science in the tidyverse: practice visualization with ggplot2, and 
  data handling by the filter() and mutate() functions.
---
...
# Make accidents dataset globally available
accidents <- read_csv("https://rb.gy/ondgxs")

# hide non-exercise code chunks
knitr::opts_chunk$set(echo = FALSE)

#mutate light conditions
accidents <- accidents %>%
  mutate(light_conditions = case_when(light_conditions == 1 ~ "1 - Daylight",
...
# mutate urban area variable
accidents <- accidents %>%
  mutate(urban_or_rural_area = case_when(urban_or_rural_area == 1 ~ "Rural",
...
- Continue practicing data visualization skills with ggplot2
- Filtering data for certain attributes with `filter()`
- Creating new variables based on existing variables in the data with `mutate()`
