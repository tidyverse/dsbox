...
#'
#' @source Retrieved from \url{https://www.ratebeer.com/breweries/north%20carolina/33/213/} on April 18, 2018.
#' @format A tibble with 251 rows and 7 variables:
#' \describe{
#'   \item{name}{Name of brewery}
#'   \item{city}{City where brewery is located}
#'   \item{type}{Type of brewery (Microbrewery, Client Brewer, Brewpub, Brewpub/Brewery, Commercial Brewery)}
